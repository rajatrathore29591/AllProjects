<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="BulkSearchResult.aspx.cs" Inherits="TradeMark.BulkSearchResult" ValidateRequest="false" %>
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    <h2><i class="fa fa-lightbulb-o" aria-hidden="true"></i><a href="#" data-toggle="modal" data-target="#searchmodal">SEARCH TIPS</a></h2>
                                </div>
                            </div>
                                    ...
                                    <asp:Panel ID="Panel1" runat="server" DefaultButton="btndefault">
                                        <div class="row">
                                            ...
                                            <div class="button-block text-right col-sm-12 col-xs-12">
                                                <%--need to add condition if (userCredit >0) then show search button else hide--%>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <ul class="arrow">
                        ...
                        <li>If your proposed mark is or contains a nickname, acronym, or abbreviation, it is better to use BOB’s nickname, acronym, or abbreviation search option. For example, IPS is the acronym for INCREDIBLE PROTEIN SNACKS and CALI is the known abbreviation for CALIFORNIA. Enter INCREDIBLE PROTEIN SNACKS or CALIFORNIA in the box where BOB asks for the long form of your proposed mark.</li>
